...
Summary2 <- readRDS("FS.rds") %>% 
  ...
  pivot_longer(everything(), names_to = "Variable", values_to = "Akaike_Adjusted_RSq") %>% 
  arrange(desc(Akaike_Adjusted_RSq)) 

GlobalSummary <- full_join(Summary1, Summary2)
...
```{r SummaryBacterialPA, echo = F, eval = F}
...
```{r BestBacterialPAModels, echo=FALSE, eval = F}
